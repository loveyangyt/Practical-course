			...
			<html:form action="/manage/student.do?action=seekPwd2" method="post" onsubmit="return checkForm(studentForm)">
			  <table width="57%" height="69" border="0" cellpadding="0" cellspacing="0">
			    <tr>
			      ...
			      <td width="50%" class="word_orange1"><span style="padding:5px;">输入密码提示问题答案</span></td>
			    </tr>
			  </table>
			  <table width="57%"  border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF" bordercolordark="#D2E3E6" bordercolorlight="#FFFFFF">
			    <tr align="center">
			    <td width="50%" height="30" align="left" class="col-sm-2 control-label">密码提示问题：</td>
			    <td width="50%" align="left">
			      <html:hidden property="ID" name="seekPwd2"/>
				  <html:text styleClass="form-control" property="question" size="40" name="seekPwd2" readonly="true"/> <span class="word_orange1"> （只读）</span>	  </td>
			    </tr>
			    <tr align="center">
			    <td width="50%" height="30" align="left" class="col-sm-2 control-label">密码提示答案：</td>
			    <td width="50%" align="left">
			      <html:text styleClass="form-control" property="answer" size="40"/> <span class="word_orange1"> *</span>	  </td>
			    </tr>	
			    <tr>
			      <td height="65" align="left" style="padding:5px;">&nbsp;</td>
			      <td><html:submit styleClass="btn btn-default" value="下一步"/>
			        &nbsp;
			        <html:reset styleClass="btn btn-default" value="取消"/>
					&nbsp;
					</td>
			    </tr>
			</table>
