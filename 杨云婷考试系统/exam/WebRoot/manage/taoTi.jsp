			  ...
			  <tr>
			    ...
			    <td width="602" valign="top" bgcolor="#FFFFFF">
			      <div class="row clearfix">
			      	...
			      	<div class="row clearfix">
						<div class="col-md-12 column">
			      			<ul class="list-inline">		      							
								<li><html:link styleClass="btn btn-default" page="/manage/taoTi.do?action=taoTiAddQuery">添加套题</html:link></li>							
							</ul>
			      		</div>
			      	</div>
			      	<div class="row clearfix">
						<div class="col-md-12 column">
							...
							<table class="table">
								...
								<bean:define id="lessonID" name="taoTi" property="lessonId" type="Integer"/>
									<tr class="success">
										<td><bean:write name="taoTi" property="name" filter="true"/></td>
										<td><%=lesson.getLesson(lessonID)%></td>
										<td><bean:write name="taoTi" property="joinTime" format="yyyy-MM-dd HH:mm:ss" filter="true"/></td>
										<td><html:link page="/manage/taoTi.do?action=taoTiModifyQuery" paramId="id" paramName="taoTi" paramProperty="ID">修改</html:link></td>
										<td><html:multibox property="delIdArray" styleClass="noborder"><bean:write name="taoTi" property="ID"/></html:multibox></td>
			      	...
			      	<div class="row clearfix">
						<div class="col-md-12 column">
							<input name="checkbox" type="checkbox" class="noborder" onClick="CheckAll(taoTiForm.delIdArray,taoTiForm.checkbox)">
